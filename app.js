...
class AnalogCamera {
    ...
    applyKodakPortra(imageData) {
        ...
        for (let i = 0; i < data.length; i += 4) {
            // Warm tones, slightly lifted blacks, soft contrast
            let r = data[i];
            let g = data[i + 1];
            let b = data[i + 2];
    ...
    applyFuji400H(imageData) {
        ...
        for (let i = 0; i < data.length; i += 4) {
            ...
            // Cool shadows, slightly green midtones
            r = r * 0.95;
    ...
    applyCineStill800T(imageData) {
        ...
        for (let i = 0; i < data.length; i += 4) {
            ...
            // Tungsten balanced - blue shadows, orange highlights
            ...
            if (luma < 128) {
                ...
                // Highlights - add warmth
                r = Math.min(255, r * 1.1);
            }
            
            // Characteristic halation (red glow in highlights)
            if (luma > 200) {
    ...
    applyIlfordHP5(imageData) {
        ...
        for (let i = 0; i < data.length; i += 4) {
            ...
            // Convert to B&W with slight warm tone
            let gray = 0.299 * r + 0.587 * g + 0.114 * b;
            
            // High contrast
            gray = ((gray / 255 - 0.5) * 1.3 + 0.5) * 255;
    ...
    applyLomoChrome(imageData) {
        ...
        for (let i = 0; i < data.length; i += 4) {
            ...
            // Cross-process effect - swap channels partially
            const newR = r * 0.6 + g * 0.2 + b * 0.2;
            const newG = r * 0.1 + g * 0.5 + b * 0.4;
            const newB = r * 0.3 + g * 0.2 + b * 0.5;
            
            // Add purple/magenta tint
            r = Math.min(255, newR * 1.1);
            g = newG * 0.9;
    ...
    viewPhoto(index) {
        ...
        viewer.innerHTML = `
            <img src="${photo.data}" alt="Full photo">
